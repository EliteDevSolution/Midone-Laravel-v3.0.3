            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        ...
                        <a href="" class="ml-auto flex text-theme-26 dark:text-theme-33">
                ...
                <div class="xxl:pl-6 grid grid-cols-12 gap-6">
                        ...
                        <div class="report-timeline mt-5 relative">
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-gray-600 mt-1">Has changed <a class="text-theme-26 dark:text-theme-33" href="">{{ $fakers[7]['products'][0]['name'] }}</a> price and description</div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="report-timeline__image">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-gray-600 mt-1">Has changed <a class="text-theme-26 dark:text-theme-33" href="">{{ $fakers[6]['products'][0]['name'] }}</a> description</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 xl:col-start-1 xl:row-start-2 xxl:col-start-auto xxl:row-start-auto mt-3">
                        <div class="intro-x flex items-center h-10">
                            ...
                            <a href="" class="ml-auto text-theme-26 dark:text-theme-33 truncate flex items-center">
