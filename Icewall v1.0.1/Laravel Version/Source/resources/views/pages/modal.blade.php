...
@section('subhead')
    <title>Modal - Icewall - Tailwind HTML Admin Template</title>
@endsection
                                ...
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="p-5 text-center border-t border-gray-200 dark:border-dark-5">
                                            <a href="" class="text-theme-17 dark:text-gray-300">Why do I have this issue?</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="mx-6">
                                            <div class="center-mode">
                                                ...
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Icewall Tailwind HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][1]) }}" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Icewall Tailwind HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][2]) }}" />
                                                    </div>
                                                </div>
                                                <div class="h-56 px-2">
                                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                                        <img alt="Icewall Tailwind HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][3]) }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
