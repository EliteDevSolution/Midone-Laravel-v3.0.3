...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <!-- BEGIN: FAQ Menu -->
        <a href="" class="intro-y col-span-12 lg:col-span-4 box py-10 border-2 border-theme-17 dark:border-theme-17">
            <i data-feather="shield" class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto"></i>
        ...
        <a href="" class="intro-y col-span-12 lg:col-span-4 box py-10">
            <i data-feather="send" class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto"></i>
            <div class="font-medium text-center text-base mt-3">Multi Application</div>
            <div class="text-gray-600 mt-2 w-3/4 text-center mx-auto">Lorem Ipsum is simply dummy text of the printing</div>
        </a>
        <a href="" class="intro-y col-span-12 lg:col-span-4 box py-10">
            <i data-feather="trending-up" class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto"></i>
