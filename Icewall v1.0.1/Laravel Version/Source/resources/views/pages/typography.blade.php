...
@section('subhead')
    <title>Typography - Icewall - Tailwind HTML Admin Template</title>
@endsection
            ...
            <div class="intro-y box">
                ...
                <div id="heading" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-5">
                            <h1 class="text-4xl text-theme-17 font-medium leading-none">h1. Heading 1</h1>
                            <h2 class="text-3xl text-gray-700 dark:text-gray-600 font-medium leading-none mt-3">h2. Heading 2</h2>
                            <h3 class="text-2xl text-theme-10 font-medium leading-none mt-3">h3. Heading 3</h3>
                            <h4 class="text-xl text-theme-23 font-medium leading-none mt-3">h4. Heading 4</h4>
                            <h5 class="text-lg text-theme-24 font-medium leading-none mt-3">h5. Heading 5</h5>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <div id="badge" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-2">
                            <span class="text-xs px-1 rounded-full bg-theme-17 text-white mr-1">1</span>
                            <span class="text-xs px-1 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span class="text-xs px-1 rounded-full bg-theme-10 text-white mr-1">3</span>
                            <span class="text-xs px-1 rounded-full bg-theme-23 text-white mr-1">4</span>
                            <span class="text-xs px-1 rounded-full bg-theme-24 text-white mr-1">5</span>
                            <span class="text-xs px-1 rounded-full bg-gray-200 text-gray-600 mr-1">6</span>
                        </div>
                        <div class="font-medium mt-6">Badge Sizes</div>
                        <div class="mt-3">
                            <span class="px-2 py-1 rounded-full bg-theme-17 text-white mr-1">1</span>
                            <span class="px-2 py-1 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span class="px-2 py-1 rounded-full bg-theme-10 text-white mr-1">3</span>
                            <span class="px-2 py-1 rounded-full bg-theme-23 text-white mr-1">4</span>
                            <span class="px-2 py-1 rounded-full bg-theme-24 text-white mr-1">5</span>
                            <span class="px-2 py-1 rounded-full bg-gray-200 text-gray-600 mr-1">6</span>
                        </div>
                        <div class="mt-4">
                            <span class="px-3 py-2 rounded-full bg-theme-17 text-white mr-1">1</span>
                            <span class="px-3 py-2 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span class="px-3 py-2 rounded-full bg-theme-10 text-white mr-1">3</span>
                            <span class="px-3 py-2 rounded-full bg-theme-23 text-white mr-1">4</span>
                            <span class="px-3 py-2 rounded-full bg-theme-24 text-white mr-1">5</span>
                            <span class="px-3 py-2 rounded-full bg-gray-200 text-gray-600 mr-1">6</span>
                        </div>
                        <div class="mt-6">
                            <span class="px-4 py-3 rounded-full bg-theme-17 text-white mr-1">1</span>
                            <span class="px-4 py-3 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span class="px-4 py-3 rounded-full bg-theme-10 text-white mr-1">3</span>
                            <span class="px-4 py-3 rounded-full bg-theme-23 text-white mr-1">4</span>
                            <span class="px-4 py-3 rounded-full bg-theme-24 text-white mr-1">5</span>
                            <span class="px-4 py-3 rounded-full bg-gray-200 text-gray-600 mr-1">6</span>
                        </div>
                        <div class="font-medium mt-10">Square Badge</div>
                        <div class="mt-2">
                            <span class="text-xs px-1 bg-theme-17 text-white mr-1">1</span>
                            <span class="text-xs px-1 border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span class="text-xs px-1 bg-theme-10 text-white mr-1">3</span>
                            <span class="text-xs px-1 bg-theme-23 text-white mr-1">4</span>
                            <span class="text-xs px-1 bg-theme-24 text-white mr-1">5</span>
                            <span class="text-xs px-1 bg-gray-200 text-gray-600 mr-1">6</span>
                        </div>
                        <div class="font-medium mt-6">Outline Badge</div>
                        <div class="mt-4">
                            <span class="px-3 py-2 rounded-full border border-theme-17 text-theme-1 dark:text-theme-10 dark:border-theme-10 mr-1">1</span>
                            <span class="px-3 py-2 rounded-full border text-gray-700 dark:text-gray-600 dark:border-dark-5 mr-1">2</span>
                            <span class="px-3 py-2 rounded-full border border-theme-10 text-theme-9 dark:border-theme-9 mr-1">3</span>
                            <span class="px-3 py-2 rounded-full border border-theme-23 text-theme-12 dark:border-theme-12 mr-1">4</span>
                            <span class="px-3 py-2 rounded-full border border-theme-24 text-theme-6 dark:border-theme-6 mr-1">5</span>
                        </div>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                ...
                <div id="link" class="p-5">
                    <div class="preview">
                        <div>
                            <a href="" class="text-theme-17 block font-normal">Example text</a>
                            <a href="" class="text-theme-17 block font-medium">Example medium text</a>
                            <a href="" class="text-theme-17 block font-semibold">Example semibold text</a>
                            <a href="" class="text-theme-17 block font-bold">Example bolder text</a>
                            <a href="" class="text-theme-17 block font-extrabold">Example boldest text</a>
                        </div>
                        <div class="mt-5">
                            <a href="" class="text-theme-17 block">Primary state</a>
                            <a href="" class="text-gray-700 dark:text-gray-600 block">Secondary state</a>
                            <a href="" class="text-theme-10 block">Success state</a>
                            <a href="" class="text-theme-23 block">Warning state</a>
                            <a href="" class="text-theme-24 block">Danger state</a>
                        </div>
                    </div>
                    <div class="source-code hidden">
