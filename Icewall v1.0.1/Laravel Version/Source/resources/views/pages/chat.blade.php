...
@section('subhead')
    <title>Chat - Icewall - Tailwind HTML Admin Template</title>
@endsection
            ...
            <div class="tab-content">
                        ...
                        @foreach (array_slice($fakers, 0, 10) as $key => $faker)
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 {{ $key ? 'mt-5' : '' }}">
                                ...
                                @if ($faker['true_false'][0])
                                    <div class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-theme-17 font-medium -mt-1 -mr-1">{{ $faker['notification_count'] }}</div>
                                @endif
                            </div>
                        @endforeach
                    </div>
                ...
                <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                    ...
                    <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/' . $fakers[3]['photos'][0]) }}">
                                <div class="w-3 h-3 bg-theme-10 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
                        ...
                        <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                            <div class="w-12 h-12 flex-none image-fit mr-1">
                                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/' . $fakers[4]['photos'][0]) }}">
                                <div class="w-3 h-3 bg-theme-10 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                            </div>
                            <div class="ml-2 overflow-hidden">
                                <div class="flex items-center">
            ...
            <div class="chat__box box">
                ...
                <div class="hidden h-full flex flex-col">
                    ...
                    <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200 dark:border-dark-5">
                                ...
                                <div class="chat-dropdown dropdown-menu">
                                    <div class="dropdown-menu__content">
                                        <div class="chat-dropdown__box box dark:bg-dark-1 flex flex-col pb-3 -mt-2">
                                            <div class="px-3 pt-3">
                                                <div class="relative text-gray-700 dark:text-gray-300">
                                                    <input type="text" class="form-control border-transparent bg-gray-200 pr-10 placeholder-theme-8" placeholder="Search emojis...">
                        ...
                        <a href="javascript:;" class="w-8 h-8 sm:w-10 sm:h-10 block bg-theme-17 text-white rounded-full flex-none flex items-center justify-center mr-5">
