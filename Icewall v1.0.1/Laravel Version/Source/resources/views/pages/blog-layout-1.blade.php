        ...
        @foreach (array_slice($fakers, 0, 9) as $faker)
            <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                <div class="flex items-center border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                    ...
                    <div class="ml-3 mr-auto">
                        ...
                        <div class="flex text-gray-600 truncate text-xs mt-0.5">
                            <a class="text-theme-17 dark:text-gray-500 inline-block truncate" href="">{{ $faker['products'][0]['category'] }}</a> <span class="mx-1">•</span> {{ $faker['formatted_times'][0] }}
                        </div>
                    </div>
                ...
                <div class="flex items-center px-5 py-3 border-t border-gray-200 dark:border-dark-5">
                    ...
                    <a href="" class="intro-x w-8 h-8 flex items-center justify-center rounded-full bg-theme-31 dark:bg-dark-5 dark:text-gray-300 text-theme-26 ml-auto tooltip" title="Share">
                        <i data-feather="share-2" class="w-3 h-3"></i>
                    </a>
                    <a href="" class="intro-x w-8 h-8 flex items-center justify-center rounded-full bg-theme-17 text-white ml-2 tooltip" title="Download PDF">
