                ...
                <div id="progressbar-label" class="p-5">
                    <div class="preview">
                        <div class="progress h-4 rounded">
                            <div class="progress-bar w-1/2 bg-theme-1 rounded" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">50%</div>
                        </div>
                        <div class="progress h-4 rounded mt-3">
                            <div class="progress-bar w-2/3 bg-theme-1 rounded" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">60%</div>
                        </div>
                        <div class="progress h-4 rounded mt-3">
                ...
                <div id="progressbar-height" class="p-5">
                    <div class="preview">
                        <div class="progress h-1 rounded">
                            <div class="progress-bar w-1/2 bg-theme-1 rounded" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="progress rounded mt-3">
                            <div class="progress-bar w-2/3 bg-theme-1 rounded" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
            ...
            <div class="intro-y box mt-5">
                ...
                <div id="progressbar-color" class="p-5">
                    <div class="preview">
                        ...
                        <div class="progress mt-3">
                            <div class="progress-bar w-2/3 bg-theme-9" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="progress mt-3">
                            <div class="progress-bar w-3/4 bg-theme-12" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="progress mt-3">
                            <div class="progress-bar w-3/4 bg-theme-6" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="source-code hidden">
