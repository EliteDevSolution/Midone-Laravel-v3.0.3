                    ...
                    <div class="preview">
                        <div class="text-center">
                            ...
                            <div id="basic-non-sticky-notification-content" class="toastify-content hidden flex flex-col sm:flex-row">
                                ...
                                <a class="font-medium text-theme-1 dark:text-gray-500 mt-1 sm:mt-0 sm:ml-40" href="">Review Changes</a>
                            </div>
                            ...
                            <div id="notification-with-actions-content" class="toastify-content hidden flex">
                                ...
                                <div class="ml-4 mr-4">
                                    ...
                                    <div class="font-medium flex mt-1.5">
                                        <a class="text-theme-1 dark:text-gray-500" href="">Restart Now</a>
                    ...
                    <div class="preview">
                        <div class="text-center">
                            ...
                            <div id="notification-with-avatar-content" class="toastify-content hidden flex">
                                ...
                                <a data-dismiss="notification" class="absolute top-0 bottom-0 right-0 flex items-center px-6 border-l border-gray-200 dark:border-dark-5 font-medium text-theme-1 dark:text-gray-500" href="javascript:;">Reply</a>
                            </div>
                            <!-- END: Notification Content -->
                            <!-- BEGIN: Notification Toggle -->
                        ...
                        <div class="text-center">
                            ...
                            <div id="notification-with-split-buttons-content" class="toastify-content hidden flex">
                                ...
                                <div class="absolute top-0 bottom-0 right-0 flex flex-col border-l border-gray-200 dark:border-dark-5">
                                    <a class="flex-1 flex items-center justify-center px-6 font-medium text-theme-1 dark:text-gray-500 border-b border-gray-200 dark:border-dark-5" href="javascript:;">View Details</a>
