                ...
                <div id="input-state" class="p-5">
                    <div class="preview">
                        <div>
                            ...
                            <input id="input-state-1" type="text" class="form-control border-theme-9" placeholder="Input text">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="input-state-2" type="text" class="form-control border-theme-12" placeholder="Input text">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="input-state-3" type="text" class="form-control border-theme-6" placeholder="Input text">
